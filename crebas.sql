...
/* Date de crÈation :  23/12/2025 15:02:17                      */
/*==============================================================*/
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('usercorge') and o.name = 'FK_USERCORG_REFERENCE_LISTE_CO')
alter table usercorge
   drop constraint FK_USERCORG_REFERENCE_LISTE_CO
go
...
alter table usercorge
   add constraint FK_USERCORG_REFERENCE_LISTE_CO foreign key (code_corge)
      references liste_corge (id)
go
